...
Shader "Mixed Reality Toolkit/CustomStandard"
{
    Properties
    {
        // Main maps.
...
#endif
                output.rgb *= lerp((ambient + directionalLightColor * diffuse * lightAttenuation + directionalLightColor * specular) * max(oneMinusMetallic, _MinMetallicLightContribution), albedo, minProperty);
